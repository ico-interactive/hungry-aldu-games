...
declare module "@package/com/mojang/serialization" {
    ...
    export interface $MapCodec<A> extends RegistryMarked<RegistryTypes.NeoforgeConditionCodecsTag, RegistryTypes.NeoforgeConditionCodecs> {}
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.NeoforgeBiomeModifierSerializers | RegistryTypes.BlockType | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.WorldgenBiomeSource | RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.EntitySubPredicateType | RegistryTypes.EnchantmentValueEffectType | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.EnchantmentProviderType | RegistryTypes.WorldgenMaterialRule | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.NeoforgeConditionCodecs;
