...
declare module "@package/com/simibubi/create/content/schematics/client/tools" {
    ...
    export class $SchematicToolBase implements $ISchematicTool {
        init(): void;
        wrapOperation$cdj000$sable$rayTraceSublevels(arg0: $Vec3_, arg1: $Vec3_, arg2: $Predicate_<any>, arg3: $Operation_<any>, arg4: $LocalPlayer, arg5: $SchematicTransformation): $RaycastHelper$PredicateTraceResult;
        renderOverlay(arg0: $Gui, arg1: $GuiGraphics, arg2: number, arg3: number, arg4: number): void;
        updateSelection(): void;
        renderOnSchematic(arg0: $PoseStack, arg1: $SuperRenderTypeBuffer): void;
        updateTargetPos(): void;
        handler$cdj000$sable$forceUpdateSelection(arg0: $CallbackInfo, arg1: $Vec3_): void;
        renderTool(arg0: $PoseStack, arg1: $SuperRenderTypeBuffer, arg2: $Vec3_): void;
        wrapOperation$cdj000$sable$rayTraceSublevels$mixinextras$bridge$10(arg0: $Vec3_, arg1: $Vec3_, arg2: $Predicate_<any>, arg3: $Operation_<any>, arg4: $LocalRef<any>, arg5: $LocalRef<any>): $RaycastHelper$PredicateTraceResult;
        constructor();
    }
    ...
    export class $DeployTool extends $PlacementToolBase {
        wrapOperation$cde000$sable$manualTransformBB(arg0: $PoseStack, arg1: number, arg2: number, arg3: number, arg4: $Operation_<any>, arg5: number, arg6: number, arg7: $Vec3_): void;
        wrapOperation$cde000$sable$manualTransformBB$mixinextras$bridge$7(arg0: $PoseStack, arg1: number, arg2: number, arg3: number, arg4: $Operation_<any>, arg5: $LocalIntRef, arg6: $LocalIntRef, arg7: $LocalRef<any>): void;
        constructor();
    }
}
