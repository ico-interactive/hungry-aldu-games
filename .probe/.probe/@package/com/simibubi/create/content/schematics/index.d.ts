...
declare module "@package/com/simibubi/create/content/schematics" {
     ...
     */
    export type $SchematicExport$SchematicExportResult_ = { fileName?: string, dir?: $Path_, origin?: $BlockPos_, bounds?: $BlockPos_, overwritten?: boolean, file?: $Path_,  } | [fileName?: string, dir?: $Path_, origin?: $BlockPos_, bounds?: $BlockPos_, overwritten?: boolean, file?: $Path_, ];
