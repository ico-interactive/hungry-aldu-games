...
declare module "@package/com/simibubi/create/content/schematics/packet" {
     ...
     */
    export type $SchematicSyncPacket_ = { anchor?: $BlockPos_, slot?: number, mirror?: $Mirror_, deployed?: boolean, rotation?: $Rotation_,  } | [anchor?: $BlockPos_, slot?: number, mirror?: $Mirror_, deployed?: boolean, rotation?: $Rotation_, ];
     ...
     */
    export type $SchematicUploadPacket_ = { size?: number, data?: number[], code?: number, schematic?: string,  } | [size?: number, data?: number[], code?: number, schematic?: string, ];
