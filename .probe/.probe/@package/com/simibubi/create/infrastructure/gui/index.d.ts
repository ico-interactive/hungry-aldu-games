...
import { $CycleButton, $Button$CreateNarration, $WidgetSprites, $Button, $Renderable } from "@package/net/minecraft/client/gui/components";
...
declare module "@package/com/simibubi/create/infrastructure/gui" {
     ...
     */
    export type $OpenCreateMenuButton$SingleMenuRow_ = { rightTextKey?: string, leftTextKey?: string,  } | [rightTextKey?: string, leftTextKey?: string, ];
