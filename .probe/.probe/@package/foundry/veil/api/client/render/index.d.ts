...
declare module "@package/foundry/veil/api/client/render" {
     ...
     */
    export type $VeilShaderBufferLayout_<T> = RegistryTypes.VeilShaderBuffer | { memoryLayout?: $ShaderBlock$MemoryLayout_, requestedBinding?: $ShaderBlock$BufferBinding_, structSpecifier?: $GlslStructSpecifier, fields?: $Map_<string, $VeilShaderBufferLayout$FieldSerializer_<any>>, name?: string,  } | [memoryLayout?: $ShaderBlock$MemoryLayout_, requestedBinding?: $ShaderBlock$BufferBinding_, structSpecifier?: $GlslStructSpecifier, fields?: $Map_<string, $VeilShaderBufferLayout$FieldSerializer_<any>>, name?: string, ];
