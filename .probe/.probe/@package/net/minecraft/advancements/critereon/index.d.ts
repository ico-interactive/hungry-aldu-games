...
declare module "@package/net/minecraft/advancements/critereon" {
     ...
     */
    export type $MovementPredicate_ = { z?: $MinMaxBounds$Doubles_, speed?: $MinMaxBounds$Doubles_, verticalSpeed?: $MinMaxBounds$Doubles_, horizontalSpeed?: $MinMaxBounds$Doubles_, x?: $MinMaxBounds$Doubles_, y?: $MinMaxBounds$Doubles_, fallDistance?: $MinMaxBounds$Doubles_,  } | [z?: $MinMaxBounds$Doubles_, speed?: $MinMaxBounds$Doubles_, verticalSpeed?: $MinMaxBounds$Doubles_, horizontalSpeed?: $MinMaxBounds$Doubles_, x?: $MinMaxBounds$Doubles_, y?: $MinMaxBounds$Doubles_, fallDistance?: $MinMaxBounds$Doubles_, ];
     ...
     */
    export type $CollectionPredicate_<T, P> = { size?: ($MinMaxBounds$Ints_) | undefined, contains?: ($CollectionContentsPredicate<T, P>) | undefined, counts?: ($CollectionCountsPredicate<T, P>) | undefined,  } | [size?: ($MinMaxBounds$Ints_) | undefined, contains?: ($CollectionContentsPredicate<T, P>) | undefined, counts?: ($CollectionCountsPredicate<T, P>) | undefined, ];
     ...
     */
    export type $BlockPredicate_ = { properties?: ($StatePropertiesPredicate_) | undefined, nbt?: ($NbtPredicate_) | undefined, blocks?: ($HolderSet_<$Block>) | undefined,  } | [properties?: ($StatePropertiesPredicate_) | undefined, nbt?: ($NbtPredicate_) | undefined, blocks?: ($HolderSet_<$Block>) | undefined, ];
     ...
     */
    export type $TradeTrigger$TriggerInstance_ = { item?: ($ItemPredicate_) | undefined, player?: ($ContextAwarePredicate) | undefined, villager?: ($ContextAwarePredicate) | undefined,  } | [item?: ($ItemPredicate_) | undefined, player?: ($ContextAwarePredicate) | undefined, villager?: ($ContextAwarePredicate) | undefined, ];
     ...
     */
    export type $EntityPredicate$LocationWrapper_ = { affectsMovement?: ($LocationPredicate_) | undefined, steppingOn?: ($LocationPredicate_) | undefined, located?: ($LocationPredicate_) | undefined,  } | [affectsMovement?: ($LocationPredicate_) | undefined, steppingOn?: ($LocationPredicate_) | undefined, located?: ($LocationPredicate_) | undefined, ];
     ...
     */
    export type $CuredZombieVillagerTrigger$TriggerInstance_ = { zombie?: ($ContextAwarePredicate) | undefined, player?: ($ContextAwarePredicate) | undefined, villager?: ($ContextAwarePredicate) | undefined,  } | [zombie?: ($ContextAwarePredicate) | undefined, player?: ($ContextAwarePredicate) | undefined, villager?: ($ContextAwarePredicate) | undefined, ];
     ...
     */
    export type $ChangeDimensionTrigger$TriggerInstance_ = { to?: ($ResourceKey_<$Level>) | undefined, player?: ($ContextAwarePredicate) | undefined, from?: ($ResourceKey_<$Level>) | undefined,  } | [to?: ($ResourceKey_<$Level>) | undefined, player?: ($ContextAwarePredicate) | undefined, from?: ($ResourceKey_<$Level>) | undefined, ];
