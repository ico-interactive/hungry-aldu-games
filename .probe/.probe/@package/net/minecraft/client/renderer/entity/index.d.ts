...
import { $ItemRendererAccessor } from "@package/net/fabricmc/fabric/mixin/client/indigo/renderer";
...
declare module "@package/net/minecraft/client/renderer/entity" {
    ...
    export class $EntityRenderer<T extends $Entity> implements $EntityRendererInter<any> {
        ...
        modifyReturnValue$bni000$sable$getPackedLightCoords(arg0: number, arg1: $Entity, arg2: number): number;
        shadowRadius: number;
        static LEASH_RENDER_STEPS: number;
        entityRenderDispatcher: $EntityRenderDispatcher;
        shadowStrength: number;
    ...
    export class $LivingEntityRenderer<T extends $LivingEntity, M extends $EntityModel<T>> extends $EntityRenderer<T> implements $RenderLayerParent<T, M>, $LivingEntityRendererAccessor<any, any> {
        scale(livingEntity: T, poseStack: $PoseStack, partialTickTime: number): void;
        /**
    ...
    export class $DisplayRenderer<T extends $Display, S> extends $EntityRenderer<T> {
         ...
         */
        getTextureLocation(entity: T): $ResourceLocation;
        redirect$dal000$axiom$render_renderState(instance: $Display): $Display$RenderState;
    ...
    export class $ItemRenderer implements $ResourceManagerReloadListener, $IdentifiableResourceReloadListener, $ItemRendererAccessor, $ItemRendererAccessor$1 {
        onResourceManagerReload(resourceManager: $ResourceManager): void;
        static fabric_callUsesDynamicDisplay$fabric_renderer_indigo_$md$961d4f$0(stack: $ItemStack_): boolean;
        ...
        handler$zhe000$fabric_renderer_indigo$hook_renderItem(arg0: $ItemStack_, arg1: $ItemDisplayContext_, arg2: boolean, arg3: $PoseStack, arg4: $MultiBufferSource_, arg5: number, arg6: number, arg7: $BakedModel, arg8: $CallbackInfo): void;
