...
declare module "@package/net/minecraft/world/phys" {
    export class $AABB implements $AABBMixin {
        ...
        static invokeGetDirection$simulated_$md$961d4f$0(aabb: $AABB_, start: $Vec3_, minDistance: number[], facing: $Direction_, deltaX: number, arg5: number, deltaY: number): $Direction;
