...
import { $AbstractSelectionList, $AbstractSliderButton, $ObjectSelectionList$Entry, $Button$CreateNarration_, $Button$OnPress_, $Button$CreateNarration, $Button$Builder, $WidgetSprites, $ObjectSelectionList, $Renderable, $Button } from "@package/net/minecraft/client/gui/components";
