...
declare module "@package/net/neoforged/neoforge/client/model/obj" {
     ...
     */
    export type $ObjModel$ModelSettings_ = { shadeQuads?: boolean, emissiveAmbient?: boolean, automaticCulling?: boolean, mtlOverride?: string, modelLocation?: $ResourceLocation_, flipV?: boolean,  } | [shadeQuads?: boolean, emissiveAmbient?: boolean, automaticCulling?: boolean, mtlOverride?: string, modelLocation?: $ResourceLocation_, flipV?: boolean, ];
