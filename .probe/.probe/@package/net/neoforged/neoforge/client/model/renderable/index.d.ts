...
declare module "@package/net/neoforged/neoforge/client/model/renderable" {
     ...
     */
    export type $BakedModelRenderable$Context_ = { randomSource?: $RandomSource, faces?: $Direction_[], data?: $ModelData, tint?: $Vector4f, state?: $BlockState_, seed?: number,  } | [randomSource?: $RandomSource, faces?: $Direction_[], data?: $ModelData, tint?: $Vector4f, state?: $BlockState_, seed?: number, ];
