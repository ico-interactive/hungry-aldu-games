...
declare module "@package/net/neoforged/neoforge/network/configuration" {
     ...
     */
    export type $CheckExtensibleEnums$EnumEntry_ = { className?: string, data?: ($CheckExtensibleEnums$ExtensionData_) | undefined, networkCheck?: $NetworkedEnum$NetworkCheck_,  } | [className?: string, data?: ($CheckExtensibleEnums$ExtensionData_) | undefined, networkCheck?: $NetworkedEnum$NetworkCheck_, ];
}
