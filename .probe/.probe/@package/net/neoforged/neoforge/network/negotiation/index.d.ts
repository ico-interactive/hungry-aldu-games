...
declare module "@package/net/neoforged/neoforge/network/negotiation" {
     ...
     */
    export type $NegotiableNetworkComponent_ = { optional?: boolean, version?: string, id?: $ResourceLocation_, flow?: ($PacketFlow_) | undefined,  } | [optional?: boolean, version?: string, id?: $ResourceLocation_, flow?: ($PacketFlow_) | undefined, ];
