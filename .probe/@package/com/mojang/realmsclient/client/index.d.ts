...
declare module "@package/com/mojang/realmsclient/client" {
     ...
     */
    export type $RealmsError$ErrorWithJsonPayload_ = { message?: string, reason?: string, code?: number, httpCode?: number,  } | [message?: string, reason?: string, code?: number, httpCode?: number, ];
