...
declare module "@package/com/simibubi/create/compat/computercraft/implementation" {
     ...
     */
    export type $ComputerUtil$Collection_ = { list?: $List_<never>, mode?: $ComputerUtil$MatchMode, map?: $Map_<never, never>,  } | [list?: $List_<never>, mode?: $ComputerUtil$MatchMode, map?: $Map_<never, never>, ];
