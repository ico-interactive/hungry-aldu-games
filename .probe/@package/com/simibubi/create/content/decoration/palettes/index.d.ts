...
import { $IronBarsBlock, $Block_, $TransparentBlock, $WallBlock, $RotatedPillarBlock, $SoundType, $StairBlock, $Block, $SlabBlock } from "@package/net/minecraft/world/level/block";
