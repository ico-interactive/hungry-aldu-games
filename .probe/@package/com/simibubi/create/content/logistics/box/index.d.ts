...
declare module "@package/com/simibubi/create/content/logistics/box" {
     ...
     */
    export type $PackageItem$PackageOrderData_ = { isFinalLink?: boolean, isFinal?: boolean, orderId?: number, fragmentIndex?: number, orderContext?: $PackageOrderWithCrafts_, linkIndex?: number,  } | [isFinalLink?: boolean, isFinal?: boolean, orderId?: number, fragmentIndex?: number, orderContext?: $PackageOrderWithCrafts_, linkIndex?: number, ];
     ...
     */
    export type $PackageStyles$PackageStyle_ = { riggingOffset?: number, type?: string, width?: number, rare?: boolean, height?: number,  } | [riggingOffset?: number, type?: string, width?: number, rare?: boolean, height?: number, ];
