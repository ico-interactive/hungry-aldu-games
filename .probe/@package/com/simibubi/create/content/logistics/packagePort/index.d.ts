...
declare module "@package/com/simibubi/create/content/logistics/packagePort" {
    ...
    export class $PackagePortTarget$ChainConveyorFrogportTarget extends $PackagePortTarget {
        handler$ccf000$sable$testSublevelDistance(arg0: $LevelAccessor, arg1: $BlockPos_, arg2: $ItemStack_, arg3: boolean, arg4: $CallbackInfoReturnable<any>, arg5: $ChainConveyorBlockEntity): void;
        flipped: boolean;
