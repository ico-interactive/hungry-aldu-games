...
declare module "@package/com/simibubi/create/foundation/pack" {
     ...
     */
    export type $DynamicPackSource_ = { packPosition?: $Pack$Position_, packType?: $PackType_, packId?: string, packResources?: $PackResources,  } | [packPosition?: $Pack$Position_, packType?: $PackType_, packId?: string, packResources?: $PackResources, ];
}
