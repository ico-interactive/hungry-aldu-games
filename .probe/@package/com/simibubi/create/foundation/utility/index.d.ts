...
declare module "@package/com/simibubi/create/foundation/utility" {
     ...
     */
    export type $DataFixerHelper$BlockPosFixer_ = { customFixer?: $Function_<$Dynamic<never>, $Dynamic<never>>, reference?: $DSL$TypeReference_, id?: string, renames?: $Map_<string, string>,  } | [customFixer?: $Function_<$Dynamic<never>, $Dynamic<never>>, reference?: $DSL$TypeReference_, id?: string, renames?: $Map_<string, string>, ];
