...
declare module "@package/dev/latvian/mods/kubejs/recipe/schema/postprocessing" {
     ...
     */
    export type $KeyPatternCleanupPostProcessor_ = { patternName?: string, component?: $RecipeComponent<never>, keyName?: string,  } | [patternName?: string, component?: $RecipeComponent<never>, keyName?: string, ];
}
