...
declare module "@package/dev/latvian/mods/kubejs/web" {
     ...
     */
    export type $LocalWebServer_ = { url?: string, server?: $KJSHTTPServer, explorerCode?: string, endpoints?: $List_<$LocalWebServer$Endpoint_>,  } | [url?: string, server?: $KJSHTTPServer, explorerCode?: string, endpoints?: $List_<$LocalWebServer$Endpoint_>, ];
