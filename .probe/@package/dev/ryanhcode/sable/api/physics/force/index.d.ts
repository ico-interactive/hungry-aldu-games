...
declare module "@package/dev/ryanhcode/sable/api/physics/force" {
     ...
     */
    export type $ForceGroup_ = RegistryTypes.SableForceGroups | { defaultDisplayed?: boolean, color?: number, name?: $Component_, description?: $Component_,  } | [defaultDisplayed?: boolean, color?: number, name?: $Component_, description?: $Component_, ];
