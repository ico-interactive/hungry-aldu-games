...
declare module "@package/dev/ryanhcode/sable/physics/config/block_properties" {
     ...
     */
    export type $PhysicsBlockPropertyTypes$PhysicsBlockPropertyType_<T> = RegistryTypes.SablePhysicsBlockProperties | { codec?: $Codec<any>, id?: number, defaultValue?: any,  } | [codec?: $Codec<any>, id?: number, defaultValue?: any, ];
