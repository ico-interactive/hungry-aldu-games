...
import { $HumanoidArm, $Entity, $AnimationState, $LivingEntity, $HumanoidArm_, $Mob } from "@package/net/minecraft/world/entity";
...
declare module "@package/net/minecraft/client/model" {
    ...
    export class $HumanoidModel<T extends $LivingEntity> extends $AgeableListModel<T> implements $ArmedModel, $HeadedModel {
        ...
        wrapMethod$zce000$createbigcannons$setupAnimHead(arg0: $LivingEntity, arg1: number, arg2: number, arg3: number, arg4: number, arg5: number, arg6: $Operation_<any>): void;
        setupAttackAnimation(livingEntity: T, ageInTicks: number): void;
