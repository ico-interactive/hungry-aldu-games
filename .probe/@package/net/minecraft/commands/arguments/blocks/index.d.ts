...
declare module "@package/net/minecraft/commands/arguments/blocks" {
     ...
     */
    export type $BlockStateParser$TagResult_ = { nbt?: $CompoundTag_, vagueProperties?: $Map_<string, string>, tag?: $HolderSet_<$Block>,  } | [nbt?: $CompoundTag_, vagueProperties?: $Map_<string, string>, tag?: $HolderSet_<$Block>, ];
