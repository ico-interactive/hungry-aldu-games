...
declare module "@package/net/minecraft" {
    ...
    export class $SystemReport implements $SystemReportAccessor {
        static getOPERATING_SYSTEM$create_$md$961d4f$0(): string;
        static getJAVA_VERSION$create_$md$961d4f$1(): string;
        ...
        constructor();
        static get OPERATING_SYSTEM$create_$md$961d4f$0(): string;
        static get JAVA_VERSION$create_$md$961d4f$1(): string;
