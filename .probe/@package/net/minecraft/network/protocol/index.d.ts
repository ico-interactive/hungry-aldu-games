...
declare module "@package/net/minecraft/network/protocol" {
     ...
     */
    export type $ProtocolInfoBuilder$Implementation_<L> = { codec?: $StreamCodec<$ByteBuf, $Packet<$PacketListener>>, flow?: $PacketFlow_, id?: $ConnectionProtocol_, bundlerInfo?: $BundlerInfo,  } | [codec?: $StreamCodec<$ByteBuf, $Packet<$PacketListener>>, flow?: $PacketFlow_, id?: $ConnectionProtocol_, bundlerInfo?: $BundlerInfo, ];
    /**
