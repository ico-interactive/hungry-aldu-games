...
declare module "@package/net/minecraft/server/network/config" {
    export class $SynchronizeRegistriesTask implements $ConfigurationTask {
        ...
        handler$zga000$fabric_resource_loader_v0$onSelectKnownPacks(arg0: $List_<any>, arg1: $Consumer_<any>, arg2: $CallbackInfo): void;
        handler$zga000$fabric_resource_loader_v0$syncRegistryAndTags(arg0: $Consumer_<any>, arg1: $Set_<any>, arg2: $CallbackInfo): void;
