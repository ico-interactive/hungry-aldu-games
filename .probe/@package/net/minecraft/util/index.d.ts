...
declare module "@package/net/minecraft/util" {
    ...
    export class $SimpleBitStorage implements $BitStorage {
        getSize(): number;
     ...
     */
    export type $CubicSpline$Multipoint_<C, I> = { values?: $List_<$CubicSpline<any, $ToFloatFunction<C>>>, derivatives?: number[], maxValue?: number, locations?: number[], minValue?: number, coordinate?: $ToFloatFunction<C>,  } | [values?: $List_<$CubicSpline<any, $ToFloatFunction<C>>>, derivatives?: number[], maxValue?: number, locations?: number[], minValue?: number, coordinate?: $ToFloatFunction<C>, ];
    ...
    export class $ZeroBitStorage implements $BitStorage {
        getSize(): number;
        /**
         * Gets the entry at the given index
         */
