...
declare module "@package/net/minecraft/world/item" {
    export class $PlaceOnWaterBlockItem extends $BlockItem {
        handler$dbn000$axiom$useOn(useOnContext: $UseOnContext, cir: $CallbackInfoReturnable<any>): void;
     ...
     */
    export type $BrushItem$DustParticlesDelta_ = { yd?: number, zd?: number, xd?: number,  } | [yd?: number, zd?: number, xd?: number, ];
    ...
    export class $AxeItem extends $DiggerItem implements $AxeItemAccessor {
        static getStrippedBlocks$fabric_content_registries_v0_$md$961d4f$0(): $Map<any, any>;
        static setStrippedBlocks$fabric_content_registries_v0_$md$961d4f$1(arg0: $Map_<any, any>): void;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get strippedBlocks$fabric_content_registries_v0_$md$961d4f$0(): $Map<any, any>;
        static set strippedBlocks$fabric_content_registries_v0_$md$961d4f$1(value: $Map_<any, any>);
    }
    ...
    export class $HoeItem extends $DiggerItem implements $HoeItemAccessor {
        static getTillingActions$fabric_content_registries_v0_$md$961d4f$0(): $Map<any, any>;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get tillingActions$fabric_content_registries_v0_$md$961d4f$0(): $Map<any, any>;
    }
    ...
    export class $CompassItem extends $Item {
        ...
        wrapOperation$znl000$simulated$setLodestoneData$mixinextras$bridge$8(arg0: $ItemStack_, arg1: $DataComponentType_<any>, arg2: $Object, arg3: $Operation_<any>, arg4: $LocalRef<any>): $Object;
        wrapOperation$znl000$simulated$setLodestoneData(arg0: $ItemStack_, arg1: $DataComponentType_<any>, arg2: $Object, arg3: $Operation_<any>, arg4: $UseOnContext): $Object;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        static MAX_BAR_WIDTH: number;
        static BASE_ATTACK_SPEED_ID: $ResourceLocation;
    ...
    export class $CreativeModeTab implements $CreativeModeTabKJS {
        ...
        handler$chp000$fabric_item_group_api_v1$getStacks(arg0: $CreativeModeTab$ItemDisplayParameters_, arg1: $CallbackInfo): void;
    ...
    export class $ShovelItem extends $DiggerItem implements $ShovelItemAccessor {
        ...
        static getPathStates$fabric_content_registries_v0_$md$961d4f$0(): $Map<any, any>;
        static BASE_ATTACK_DAMAGE_ID: $ResourceLocation;
        static DEFAULT_MAX_STACK_SIZE: number;
        tier: $Tier;
        ...
        static BY_BLOCK: $Map<$Block, $Item>;
        constructor(tier: $Tier_, properties: $Item$Properties);
        static get pathStates$fabric_content_registries_v0_$md$961d4f$0(): $Map<any, any>;
    }
    ...
    export class $DiggerItem extends $TieredItem implements $DiggerItemKJS {
        ...
        handler$zhl000$kubejs$init(ci: $CallbackInfo, blocks: $TagKey_<any>): void;
    ...
    export class $BucketItem extends $Item implements $DispensibleContainerItem {
        /**
    ...
    export class $Item$Properties implements $IItemPropertiesExtensions, $FabricItem$Settings {
    ...
    export class $ItemStack implements $DataComponentHolder, $MutableDataComponentHolder, $IItemStackExtension, $ItemStackExtensions$1, $ItemStackExtensions, $FabricItemStack, $ItemStackKJS {
        ...
        handler$dbp000$axiom$addAttributeTooltips(consumer: $Consumer_<any>, player: $Player, ci: $CallbackInfo): void;
        /**
         * Called as the stack is being used by an entity.
         */
        ...
        handler$cjk000$fabric_entity_events_v1$canElytraFly(arg0: $LivingEntity, arg1: $CallbackInfoReturnable<any>): void;
        /**
         * Used to determine if the player can use Elytra flight.
         * This is called Client and Server side.
         */
    ...
    export class $BlockItem extends $Item implements $InvokerBlockItem {
        getBlock(): $Block;
        ...
        wrapOperation$dbg000$axiom$place$updatePlacementContext(instance: $BlockItem, blockPlaceContext: $BlockPlaceContext, original: $Operation_<any>): $BlockPlaceContext;
        ...
        modifyReturnValue$dbg000$axiom$canPlace(canPlace: boolean, blockPlaceContext: $BlockPlaceContext): boolean;
        wrapOperation$dbg000$axiom$place$getPlacementState(instance: $BlockItem, blockPlaceContext: $BlockPlaceContext, original: $Operation_<any>): $BlockState;
    ...
    export class $SpawnEggItem extends $Item {
        ...
        get defaultType(): $EntityType<never>;
    }
    ...
    export class $Item implements $FeatureElement, $ItemLike, $IItemExtension, $ItemVariantCache, $ItemAccessor, $FabricItem, $ItemExtensions, $ItemInvoker, $ItemKJS {
        ...
        static getPlayerPOVHitResult$sable_$md$961d4f$0(level: $Level_, player: $Player, fluidMode: $ClipContext$Fluid_): $BlockHitResult;
        ...
        handler$zdc000$fabric_item_api_v1$getCraftingRemainingItem(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        handler$zdc000$fabric_item_api_v1$hasCraftingRemainingItem(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        handler$zdh000$fabric_item_api_v1$shouldCauseBlockBreakReset(arg0: $ItemStack_, arg1: $ItemStack_, arg2: $CallbackInfoReturnable<any>): void;
        ...
        handler$zdc000$fabric_item_api_v1$getEquipmentSlot(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        handler$bbe000$connector$redirectIsPiglinCurrency(arg0: $ItemStack_, arg1: $CallbackInfoReturnable<any>): void;
        ...
        modifyReturnValue$zdh000$fabric_item_api_v1$shouldCauseReequipAnimation(arg0: boolean, arg1: $ItemStack_, arg2: $ItemStack_, arg3: boolean): boolean;
        /**
         * Used to determine if the player can use Elytra flight.
         * This is called Client and Server side.
         */
