...
import { $ChunkRenderTypeSetAccessor } from "@package/dev/eriksonn/aeronautics/mixin/levitite";
...
declare module "@package/net/neoforged/neoforge/client" {
    ...
    export class $ChunkRenderTypeSet implements $Iterable<$RenderType>, $ChunkRenderTypeSetAccessor, $ExtendedChunkRenderTypeSet {
        static setChunkRenderTypesList$aeronautics_$md$961d4f$0(arg0: $List_<any>): void;
        static setChunkRenderTypes$aeronautics_$md$961d4f$1(arg0: $RenderType[]): void;
        isEmpty(): boolean;
        ...
        static set chunkRenderTypesList$aeronautics_$md$961d4f$0(value: $List_<any>);
        static set chunkRenderTypes$aeronautics_$md$961d4f$1(value: $RenderType[]);
        get empty(): boolean;
        get bits(): $BitSet;
    }
