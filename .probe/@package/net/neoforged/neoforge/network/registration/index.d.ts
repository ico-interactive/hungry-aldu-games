...
declare module "@package/net/neoforged/neoforge/network/registration" {
     ...
     */
    export type $ModdedConfigurationPayloadRegistration_<T> = { handler?: $IPayloadHandler_<$CustomPacketPayload>, reader?: $StreamCodec<$FriendlyByteBuf, $CustomPacketPayload_>, id?: $ResourceLocation_, type?: $Class<$CustomPacketPayload_>,  } | [handler?: $IPayloadHandler_<$CustomPacketPayload>, reader?: $StreamCodec<$FriendlyByteBuf, $CustomPacketPayload_>, id?: $ResourceLocation_, type?: $Class<$CustomPacketPayload_>, ];
    /**
    ...
    export class $NetworkRegistry implements $NetworkRegistryAccessor {
        ...
        static setSetup$fabric_networking_api_v1_$md$961d4f$2(arg0: boolean): void;
        static getSetup$fabric_networking_api_v1_$md$961d4f$1(): boolean;
        static getPayloadRegistrations$fabric_networking_api_v1_$md$961d4f$0(): $Map<any, any>;
        /**
         * Invoked by the client when a modded server queries it for its available channels. The negotiation happens solely on the server side, and the result is later transmitted to the client.
         * 
         * Invoked on the network thread.
        ...
        static set setup$fabric_networking_api_v1_$md$961d4f$2(value: boolean);
        static get setup$fabric_networking_api_v1_$md$961d4f$1(): boolean;
        static get payloadRegistrations$fabric_networking_api_v1_$md$961d4f$0(): $Map<any, any>;
    }
}
